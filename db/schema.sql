...
CREATE TABLE IF NOT EXISTS official_program_coverage_batch_packets (
  coverage_batch_packet_key TEXT PRIMARY KEY,
  official_program_coverage_batch_key TEXT NOT NULL REFERENCES official_program_coverage_batches(official_program_coverage_batch_key) ON DELETE CASCADE,
  execution_order INTEGER NOT NULL DEFAULT 0,
  batch_packet_order INTEGER NOT NULL DEFAULT 0,
  queue_key TEXT NOT NULL REFERENCES official_program_coverage_action_queue(queue_key) ON DELETE CASCADE,
  dossier_key TEXT,
  official_program_key TEXT REFERENCES official_program_universe(official_program_key) ON DELETE CASCADE,
  official_program_name TEXT NOT NULL,
  official_program_type TEXT NOT NULL,
  ...
  accepted_alias_mapping_count INTEGER NOT NULL DEFAULT 0,
  accepted_alias_people_count INTEGER NOT NULL DEFAULT 0,
  dossier_candidate_source_count INTEGER NOT NULL DEFAULT 0,
  target_artifact TEXT NOT NULL,
  required_next_evidence TEXT NOT NULL,
  recommended_next_action TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS training_temporal_contract_batch_packets (
  training_temporal_contract_batch_packet_key TEXT PRIMARY KEY,
  temporal_contract_batch_key TEXT NOT NULL REFERENCES training_temporal_contract_batches(temporal_contract_batch_key) ON DELETE CASCADE,
  execution_order INTEGER NOT NULL DEFAULT 0,
  packet_order INTEGER NOT NULL DEFAULT 0,
  ...
  evidence_required_to_complete TEXT NOT NULL,
  stale_information_policy TEXT NOT NULL,
  contract_evidence_json TEXT NOT NULL,
  batch_evidence_json TEXT NOT NULL,
  evidence_json TEXT NOT NULL,
  generated_at TEXT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS person_training_stage_state (
  ...
  current_temporal_state_code TEXT NOT NULL,
  temporal_validity_status TEXT NOT NULL,
  stage_state_status TEXT NOT NULL,
  staleness_bucket TEXT NOT NULL,
  expected_next_stage TEXT,
  expected_next_date TEXT,
  expected_exit_date TEXT,
  stale_after_date TEXT,
  ...
  diff_readiness_status TEXT NOT NULL,
  next_refresh_contract TEXT NOT NULL,
  next_refresh_expected_behavior TEXT NOT NULL,
  expected_if_missing_on_next_refresh TEXT NOT NULL,
  expected_if_same_stage_on_next_refresh TEXT NOT NULL,
  expected_if_expected_next_stage_on_next_refresh TEXT NOT NULL,
  allowed_auto_diff_outcomes_json TEXT NOT NULL,
  review_trigger_json TEXT NOT NULL,
  evidence_required_to_retain TEXT NOT NULL,
  evidence_required_to_advance TEXT NOT NULL,
  ...
  stale_information_policy TEXT NOT NULL,
  recommended_operator_action TEXT NOT NULL,
  duplicate_contract_count_for_canonical_key INTEGER NOT NULL DEFAULT 0,
  stale_by_refresh INTEGER NOT NULL DEFAULT 0,
  advance_due_by_refresh INTEGER NOT NULL DEFAULT 0,
  completion_window_by_refresh INTEGER NOT NULL DEFAULT 0,
  source_refresh_required_by_refresh INTEGER NOT NULL DEFAULT 0,
  ...
  fresh_observation_required INTEGER NOT NULL DEFAULT 0,
  confidence REAL,
  state_machine_evidence_json TEXT NOT NULL,
  generated_at TEXT NOT NULL
);

CREATE INDEX IF NOT EXISTS idx_person_training_stage_state_person_program
ON person_training_stage_state(person_key, program_name, role);

CREATE INDEX IF NOT EXISTS idx_person_training_stage_state_policy
ON person_training_stage_state(role, trainee_category, policy_lane, diff_readiness_status);

CREATE TABLE IF NOT EXISTS training_stage_state_rollups (
  rollup_key TEXT PRIMARY KEY,
  rollup_scope TEXT NOT NULL,
  rollup_value TEXT NOT NULL,
  institution TEXT,
  ...
  lifecycle_code TEXT,
  projected_refresh_date TEXT NOT NULL,
  stage_state_count INTEGER NOT NULL DEFAULT 0,
  canonical_person_program_count INTEGER NOT NULL DEFAULT 0,
  person_count INTEGER NOT NULL DEFAULT 0,
  program_count INTEGER NOT NULL DEFAULT 0,
  deterministic_advancement_count INTEGER NOT NULL DEFAULT 0,
  deterministic_completion_count INTEGER NOT NULL DEFAULT 0,
  ...
  duplicate_contract_count INTEGER NOT NULL DEFAULT 0,
  stale_by_refresh_count INTEGER NOT NULL DEFAULT 0,
  fresh_observation_required_count INTEGER NOT NULL DEFAULT 0,
  auto_classifiable_transition_count INTEGER NOT NULL DEFAULT 0,
  dominant_stage_state_status TEXT NOT NULL,
  dominant_staleness_bucket TEXT NOT NULL,
  dominant_policy_lane TEXT NOT NULL,
  dominant_diff_readiness_status TEXT NOT NULL,
  recommended_operator_action TEXT NOT NULL,
  stale_information_policy TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS official_roster_refresh_batch_packets (
  official_roster_refresh_batch_packet_key TEXT PRIMARY KEY,
  roster_batch_key TEXT NOT NULL REFERENCES official_roster_refresh_batches(roster_batch_key),
  execution_order INTEGER NOT NULL DEFAULT 0,
  batch_packet_order INTEGER NOT NULL DEFAULT 0,
  refresh_key TEXT NOT NULL REFERENCES official_roster_refresh_workbench(refresh_key),
  source_key TEXT,
  source_url TEXT,
  source_title TEXT,
  source_type TEXT,
...
CREATE TABLE IF NOT EXISTS official_profile_discovery_batch_packets (
  profile_discovery_packet_key TEXT PRIMARY KEY,
  official_profile_discovery_batch_key TEXT NOT NULL REFERENCES official_profile_discovery_batches(official_profile_discovery_batch_key) ON DELETE CASCADE,
  execution_order INTEGER NOT NULL DEFAULT 0,
  batch_packet_order INTEGER NOT NULL DEFAULT 0,
  profile_workbench_key TEXT NOT NULL REFERENCES official_profile_discovery_workbench(profile_workbench_key) ON DELETE CASCADE,
  person_key TEXT NOT NULL REFERENCES people(person_key) ON DELETE CASCADE,
  ...
  best_candidate_http_status INTEGER,
  best_candidate_features TEXT,
  reviewer_decision_key TEXT,
  reviewer_dossier_key TEXT,
  reviewer_queue_status TEXT,
  reviewer_decision_status TEXT,
  ...
  sample_queries_json TEXT NOT NULL,
  candidate_evidence_json TEXT NOT NULL,
  reviewer_dossier_json TEXT NOT NULL,
  acceptance_boundary TEXT NOT NULL,
  evidence_json TEXT NOT NULL,
  generated_at TEXT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS attending_trend_reviewer_decision_dossiers (
  dossier_key TEXT PRIMARY KEY,
  reviewer_decision_key TEXT NOT NULL REFERENCES attending_trend_reviewer_decision_queue(reviewer_decision_key) ON DELETE CASCADE,
  trend_acceptance_key TEXT NOT NULL REFERENCES attending_trend_acceptance_audit(trend_acceptance_key) ON DELETE CASCADE,
  trend_claim_key TEXT NOT NULL REFERENCES attending_trend_review_claims(trend_claim_key) ON DELETE CASCADE,
  trend_key TEXT NOT NULL,
  event_group_key TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS attending_trend_discovery_packets (
  trend_discovery_packet_key TEXT PRIMARY KEY,
  attending_trend_discovery_batch_key TEXT REFERENCES attending_trend_discovery_batches(attending_trend_discovery_batch_key) ON DELETE CASCADE,
  batch_execution_order INTEGER NOT NULL DEFAULT 0,
  trend_workbench_key TEXT NOT NULL REFERENCES attending_trend_discovery_workbench(trend_workbench_key) ON DELETE CASCADE,
  trend_key TEXT NOT NULL,
  event_group_key TEXT NOT NULL,
  display_name TEXT NOT NULL,
  normalized_name TEXT NOT NULL,
  ...
  source_urls TEXT,
  reviewer_decision_keys TEXT,
  claim_fingerprints TEXT,
  query_bundle_json TEXT NOT NULL,
  candidate_review_json TEXT NOT NULL,
  reviewer_dossiers_json TEXT NOT NULL,
  manual_action_template_json TEXT NOT NULL,
  evidence_json TEXT NOT NULL,
  generated_at TEXT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS contact_verification_batch_packets (
  contact_verification_batch_packet_key TEXT PRIMARY KEY,
  contact_verification_batch_key TEXT NOT NULL REFERENCES contact_verification_batches(contact_verification_batch_key) ON DELETE CASCADE,
  execution_order INTEGER NOT NULL DEFAULT 0,
  packet_order INTEGER NOT NULL DEFAULT 0,
  dossier_key TEXT NOT NULL,
  reviewer_decision_key TEXT NOT NULL,
  contact_contract_key TEXT NOT NULL,
  contact_assurance_key TEXT,
  ...
  allowed_decisions TEXT NOT NULL,
  manual_decision_template_json TEXT NOT NULL,
  dossier_evidence_json TEXT NOT NULL,
  batch_evidence_json TEXT NOT NULL,
  evidence_json TEXT NOT NULL,
  generated_at TEXT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS person_enrichment_action_member_execution_dossiers (
  dossier_key TEXT PRIMARY KEY,
  execution_decision_key TEXT NOT NULL REFERENCES person_enrichment_action_member_execution_queue(execution_decision_key) ON DELETE CASCADE,
  action_batch_member_key TEXT NOT NULL REFERENCES person_enrichment_action_batch_members(action_batch_member_key) ON DELETE CASCADE,
  action_batch_key TEXT NOT NULL,
  action_packet_key TEXT NOT NULL,
  person_key TEXT NOT NULL REFERENCES people(person_key) ON DELETE CASCADE,
  ...
  dossier_status TEXT NOT NULL,
  execution_risk_level TEXT NOT NULL,
  task_count INTEGER NOT NULL DEFAULT 0,
  review_packet_count INTEGER NOT NULL DEFAULT 0,
  profile_workbench_count INTEGER NOT NULL DEFAULT 0,
  contact_contract_count INTEGER NOT NULL DEFAULT 0,
  ...
  top_source_urls TEXT,
  allowed_execution_decisions TEXT NOT NULL,
  manual_execution_template_json TEXT NOT NULL,
  command_hints_json TEXT NOT NULL,
  next_action_sequence_json TEXT NOT NULL,
  output_routing_checklist_json TEXT NOT NULL,
  downstream_artifact_summary_json TEXT NOT NULL,
  missing_execution_summary TEXT NOT NULL,
  recommended_operator_action TEXT NOT NULL,
  acceptance_boundary TEXT NOT NULL,
  member_fingerprint TEXT NOT NULL,
  evidence_json TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS person_enrichment_action_member_execution_packets (
  execution_packet_key TEXT PRIMARY KEY,
  action_batch_key TEXT NOT NULL,
  primary_action_lane TEXT NOT NULL,
  execution_status TEXT NOT NULL,
  queue_status TEXT NOT NULL,
  ...
  manual_review_member_count INTEGER NOT NULL DEFAULT 0,
  collector_execution_member_count INTEGER NOT NULL DEFAULT 0,
  max_packet_priority INTEGER NOT NULL DEFAULT 0,
  min_packet_priority INTEGER NOT NULL DEFAULT 0,
  total_task_count INTEGER NOT NULL DEFAULT 0,
  total_review_packet_count INTEGER NOT NULL DEFAULT 0,
  total_profile_workbench_count INTEGER NOT NULL DEFAULT 0,
  total_contact_contract_count INTEGER NOT NULL DEFAULT 0,
  ...
  acceptance_boundary TEXT NOT NULL,
  allowed_execution_decisions TEXT NOT NULL,
  manual_execution_templates_json TEXT NOT NULL,
  command_hints_json TEXT NOT NULL,
  output_routing_checklist_json TEXT NOT NULL,
  expected_downstream_artifacts_json TEXT NOT NULL,
  top_dossiers_json TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS research_identity_review_batches (
  review_batch_key TEXT PRIMARY KEY,
  execution_order INTEGER NOT NULL DEFAULT 0,
  research_identity_status TEXT NOT NULL,
  recommended_review_route TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS research_identity_review_batch_members (
  review_batch_member_key TEXT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS research_identity_review_batch_member_packets (
  member_packet_key TEXT PRIMARY KEY,
  batch_packet_key TEXT NOT NULL REFERENCES research_identity_review_batch_packets(batch_packet_key) ON DELETE CASCADE,
  review_batch_key TEXT NOT NULL REFERENCES research_identity_review_batches(review_batch_key) ON DELETE CASCADE,
  review_batch_member_key TEXT NOT NULL REFERENCES research_identity_review_batch_members(review_batch_member_key) ON DELETE CASCADE,
  reviewer_decision_key TEXT,
  dossier_key TEXT,
...
CREATE TABLE IF NOT EXISTS search_utility_execution_batches (
  search_utility_execution_batch_key TEXT PRIMARY KEY,
  execution_order INTEGER NOT NULL DEFAULT 0,
  ...
  observation_artifact TEXT NOT NULL,
  candidate_artifact TEXT NOT NULL,
  query_kind_signature TEXT NOT NULL,
  priority_band_signature TEXT NOT NULL,
  http_status_signature TEXT NOT NULL,
  error_signature TEXT NOT NULL,
  candidate_status_signature TEXT NOT NULL,
  batch_row_count INTEGER NOT NULL DEFAULT 0,
  query_count INTEGER NOT NULL DEFAULT 0,
  observed_query_count INTEGER NOT NULL DEFAULT 0,
  unobserved_query_count INTEGER NOT NULL DEFAULT 0,
  failed_observation_count INTEGER NOT NULL DEFAULT 0,
  candidate_count INTEGER NOT NULL DEFAULT 0,
  search_candidate_count INTEGER NOT NULL DEFAULT 0,
  result_count INTEGER NOT NULL DEFAULT 0,
  person_count INTEGER NOT NULL DEFAULT 0,
  program_count INTEGER NOT NULL DEFAULT 0,
  max_priority INTEGER NOT NULL DEFAULT 0,
  ...
  top_entities TEXT,
  top_domains TEXT,
  query_kind_counts_json TEXT NOT NULL,
  http_status_counts_json TEXT NOT NULL,
  ...
  target_artifact TEXT NOT NULL,
  sample_queries_json TEXT NOT NULL,
  sample_observations_json TEXT NOT NULL,
  sample_candidates_json TEXT NOT NULL,
  evidence_json TEXT NOT NULL,
  generated_at TEXT NOT NULL
);

CREATE TABLE IF NOT EXISTS search_utility_execution_batch_packets (
  search_utility_execution_batch_packet_key TEXT PRIMARY KEY,
  search_utility_execution_batch_key TEXT NOT NULL REFERENCES search_utility_execution_batches(search_utility_execution_batch_key),
  execution_order INTEGER NOT NULL DEFAULT 0,
  batch_packet_order INTEGER NOT NULL DEFAULT 0,
  utility_key TEXT NOT NULL,
  utility_name TEXT NOT NULL,
