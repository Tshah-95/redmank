...
created_at: 2026-06-09T08:49:02.878990+00:00
...
```json
{
  ...
  "by_action_status": {
    ...
    "ready_and_passing": 1,
    "ready_for_fail_closed_verified_reviewer_input": 1,
  ...
  "generated_at": "2026-06-09T08:49:02.878990+00:00",
  "high_rows": 1,
  ...
  "rowset_sha256": "4ef7a1fa02a8b75098c3c5e101e06e6f6c725ff3c1b6494ee5fd74f8920aef9b",
  ...
  "source_verification_rowset_sha256": "20732de8041c1ba95e14613c8ff2dc965f99cc2b03d4c5c373e2c5b051a7d356",
  "total_impact_count": 512,
  "worklist_rows": 4
}
```
...
| ---: | --- | --- | ---: | ---: | --- | --- | --- |
| 1 | verify_public_clone_substrate | ready_and_passing | 980 | 35 | artifacts/data/top50_public_clone_verification_summary.json | artifacts/data/top50_public_clone_verification_summary.json | Run python3 scripts/materialize_top50_public_clone_verification.py after any public top-50 artifact change. |
...
| 3 | vanderbilt_active_gap_manifest_triage | ready_for_fail_closed_verified_reviewer_input | 760 | 159 | artifacts/data/vanderbilt_reviewer_execution_readiness_bridge.csv | artifacts/data/vanderbilt_reviewer_blank_execution_verification.csv | Use artifacts/data/vanderbilt_reviewer_blank_execution_verification.csv plus the slice index to choose one bounded reviewer slice. Fill only allowed non-mutating reviewer decisions, extract a strict patch, dry-run apply, and do not run --apply until that slice is reviewed. |
