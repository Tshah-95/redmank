...
created_at: 2026-06-09T07:27:26.114963+00:00
...
```json
{
  ...
  "generated_at": "2026-06-09T07:27:26.114963+00:00",
  "high_rows": 1,
  ...
  "rowset_sha256": "d762fb0a2c9682c08f5d698687b5a6dc4d3e625bb095f59247da36b4ac0aa45c",
  ...
  "source_verification_rowset_sha256": "78131414de65e86916d336a26d7675f15b085b57903095ef88e703c89317c12f",
  "total_impact_count": 457,
  "worklist_rows": 4
}
```
...
| ---: | --- | --- | ---: | ---: | --- | --- | --- |
| 1 | verify_public_clone_substrate | ready_and_passing | 980 | 26 | artifacts/data/top50_public_clone_verification_summary.json | artifacts/data/top50_public_clone_verification_summary.json | Run python3 scripts/materialize_top50_public_clone_verification.py after any public top-50 artifact change. |
...
| 3 | vanderbilt_active_gap_manifest_triage | ready_for_non_mutating_source_discovery_planning | 760 | 113 | artifacts/data/school_gap_resolution_batch_packets.csv | artifacts/data/school_gap_resolution_review_template.csv | Use artifacts/data/school_gap_resolution_review_template.csv for non-mutating source-discovery planning, or choose a bounded batch from artifacts/data/school_gap_resolution_batch_slice_index.csv and slice it with scripts/slice_school_gap_resolution_batch_packets.py. Validate filled template rows with scripts/validate_school_gap_resolution_review_template.py before requesting any later approval. |
