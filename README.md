...
- Preserve prior successful public roster rows when a later refresh has a transport-level fetch error, and let state-machine stale/review policy decide whether the observation can be retained, advanced, completed, or routed to review.
