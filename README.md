...
- `artifacts/data/top50_public_substrate_check_contract_summary.json`: aggregate non-mutating check contract that runs the current public clone, contributor worklist, Vanderbilt handoff, synthetic dry-run, slice-2 approval-request, slice-2 route-observation, and fail-closed gates as one CI-style surface.
