...
PROGRAM_ALIASES = {
    ...
    ("residency", "neurology"): ["Neurology Residency"],
    ("residency", "pathology - anatomic and clinical"): ["Pathology - Anatomic and Clinical Residency"],
    ...
    ("fellowship", "gastrointestinal and hepatic pathology selective"): ["GI/Hepatic Pathology Fellowship"],
    ("fellowship", "soft tissue bone selective"): ["Soft Tissue/Bone Pathology Fellowship"],
    ("fellowship", "surgical pathology selective"): ["Surgical Pathology Fellowship"],
