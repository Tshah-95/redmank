...
CSV_TABLES = [
    ...
    ("training_temporal_contract_batches.csv", "training_temporal_contract_batches"),
    ("training_temporal_contract_batch_packets.csv", "training_temporal_contract_batch_packets"),
    ...
    ("official_roster_refresh_batch_packets.csv", "official_roster_refresh_batch_packets"),
    ...
    ("official_profile_discovery_batches.csv", "official_profile_discovery_batches"),
    ("official_profile_discovery_batch_packets.csv", "official_profile_discovery_batch_packets"),
    ...
    ("person_enrichment_action_member_execution_dossiers.csv", "person_enrichment_action_member_execution_dossiers"),
    ("person_enrichment_action_member_execution_packets.csv", "person_enrichment_action_member_execution_packets"),
    ("person_enrichment_action_execution_plan.csv", "person_enrichment_action_execution_plan"),
    ("research_identity_corroboration.csv", "research_identity_corroboration"),
    ("research_identity_review_batches.csv", "research_identity_review_batches"),
    ("research_identity_review_batch_members.csv", "research_identity_review_batch_members"),
    ("research_identity_reviewer_decisions.csv", "research_identity_reviewer_decisions"),
    ("research_identity_reviewer_decision_queue.csv", "research_identity_reviewer_decision_queue"),
    ("research_identity_reviewer_decision_audit.csv", "research_identity_reviewer_decision_audit"),
    ("research_identity_reviewer_decision_dossiers.csv", "research_identity_reviewer_decision_dossiers"),
    ...
    ("person_evidence_review_dossiers.csv", "person_evidence_review_dossiers"),
    ...
    ("attending_trend_reviewer_decision_dossiers.csv", "attending_trend_reviewer_decision_dossiers"),
