...
TASK_EXECUTION = {
    ...
    "official_profile_search": {
        ...
        "existing_collector": "scripts/discover_trainee_official_profiles.py",
        "command_hint": "python3 scripts/discover_trainee_official_profiles.py --max-people 556 --max-results 4 --probe-pages --sleep 0.2",
        "input_artifacts": [
        ...
        "output_artifacts": [
            ...
            "artifacts/data/trainee_profile_discovery_claims.json",
            "artifacts/data/evidence_reconciliation_decisions.csv",
        ],
        "requires_network": 1,
        "requires_manual_review": 0,
        "requires_script_extension": 0,
        "requires_new_parser": 0,
        "readiness_reason": "Profile search now has a queue-driven discovery collector that records official profile URL candidates with query/probe provenance; acceptance remains reconciliation-bound.",
        "next_system_action": "run_official_trainee_profile_discovery_then_reconcile_candidates",
    },
    ...
    "source_medical_school_background": {
        "execution_lane": "queue_driven_collector_available",
        "automation_status": "collector_available_queue_driven",
        "existing_collector": "scripts/discover_prior_training_background.py",
        "command_hint": "python3 scripts/discover_prior_training_background.py --max-queries-per-task 2 --max-results 4 --search-timeout 8 --sleep 0.2",
        "input_artifacts": [
            "artifacts/data/person_enrichment_queue.csv",
        ...
        "output_artifacts": [
            ...
            "artifacts/data/prior_training_discovery_claims.json",
            "artifacts/data/evidence_reconciliation_decisions.csv",
        ],
        "requires_network": 1,
        "requires_manual_review": 1,
        "requires_script_extension": 0,
        "requires_new_parser": 0,
        "readiness_reason": "Medical-school background now has a queue-driven public search collector; discovered fields remain candidate evidence until source-text review.",
        "next_system_action": "run_prior_training_background_discovery_then_reconcile_candidates",
    },
    "source_residency_background": {
        ...
        "requires_script_extension": 0,
        "requires_new_parser": 0,
        "readiness_reason": "Fellow prior-residency background now has a queue-driven public search collector; discovered fields remain candidate evidence until source-text review.",
        "next_system_action": "run_prior_training_background_discovery_then_reconcile_candidates",
    },
